...
public class SwaggerConfig {
    ...
    private Map<String, Header> getDefaultResponseHeaders() {
        ...
        defaultHeaders.put(BluePrintConstants.RESPONSE_HEADER_TRANSACTION_ID,
            new Header(BluePrintConstants.RESPONSE_HEADER_TRANSACTION_ID, "Transaction Id",
                new ModelRef(stringModelRef)));
        defaultHeaders.put(BluePrintConstants.RESPONSE_HEADER_LATEST_VERSION,
            new Header(BluePrintConstants.RESPONSE_HEADER_LATEST_VERSION, "API Latest Version",
                new ModelRef(stringModelRef)));
        defaultHeaders.put(BluePrintConstants.RESPONSE_HEADER_MINOR_VERSION,
            new Header(BluePrintConstants.RESPONSE_HEADER_MINOR_VERSION, "API Minor Version",
                new ModelRef(stringModelRef)));
        defaultHeaders.put(BluePrintConstants.RESPONSE_HEADER_PATCH_VERSION,
            new Header(BluePrintConstants.RESPONSE_HEADER_PATCH_VERSION, "API Patch Version",
                new ModelRef(stringModelRef)));
