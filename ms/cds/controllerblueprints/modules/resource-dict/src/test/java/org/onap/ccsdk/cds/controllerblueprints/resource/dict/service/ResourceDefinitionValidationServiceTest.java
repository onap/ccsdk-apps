...
import org.onap.ccsdk.cds.controllerblueprints.core.service.BluePrintRepoFileService;
...
public class ResourceDefinitionValidationServiceTest {
    ...
    private void testValidate(String fileName) throws Exception {
        ...
        ResourceDefinition resourceDefinition = JacksonUtils.Companion
            .readValueFromFile(fileName, ResourceDefinition.class);
        ...
        Assert.assertNotNull(String.format("Failed to populate dictionaryDefinition for : %s", fileName),
            resourceDefinition);
    }
}
