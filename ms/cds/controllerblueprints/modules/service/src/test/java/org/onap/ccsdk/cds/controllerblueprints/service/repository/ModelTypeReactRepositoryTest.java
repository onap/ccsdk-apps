...
public class ModelTypeReactRepositoryTest {
    ...
    public void test02Finds() {
        ...
        List<ModelType> dbFindByDefinitionType =
            modelTypeReactRepository.findByDefinitionType(BluePrintConstants.MODEL_DEFINITION_TYPE_DATA_TYPE)
                .collectList().block();
        ...
        List<ModelType> dbFindByDerivedFrom =
            modelTypeReactRepository.findByDerivedFrom(BluePrintConstants.MODEL_TYPE_DATATYPES_ROOT).collectList()
                .block();
        ...
        List<ModelType> dbFindByDefinitionTypeIn =
            modelTypeReactRepository
                .findByDefinitionTypeIn(Arrays.asList(BluePrintConstants.MODEL_DEFINITION_TYPE_DATA_TYPE)).collectList()
                .block();
        ...
        List<ModelType> dbFindByDerivedFromIn =
            modelTypeReactRepository.findByDerivedFromIn(Arrays.asList(BluePrintConstants.MODEL_TYPE_DATATYPES_ROOT))
                .collectList().block();
