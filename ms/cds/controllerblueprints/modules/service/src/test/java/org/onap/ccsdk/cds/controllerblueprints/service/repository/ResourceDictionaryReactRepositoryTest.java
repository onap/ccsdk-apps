...
public class ResourceDictionaryReactRepositoryTest {
    ...
    public void test01Save() {
        ResourceDefinition resourceDefinition = JacksonUtils.Companion.readValueFromFile(
            "./../model-catalog/resource-dictionary/starter-dictionary/sample-db-source.json",
