...
@ContextConfiguration(classes = arrayOf(org.onap.ccsdk.cds.controllerblueprints.TestApplication::class))
...
class BluePrintEnhancerServiceImplTest {
    ...
    fun init() {
        runBlocking {
            modelTypeLoadService!!.loadPathModelType("./../model-catalog/definition-type/starter-type")
            resourceDictionaryLoadService!!.loadPathResourceDictionary("./../model-catalog/resource-dictionary/starter-dictionary")
        }
    }
    ...
    fun testEnhancementAndValidation() {
        ...
        val basePath = "./../model-catalog/blueprint-model/starter-blueprint/baseconfiguration"
