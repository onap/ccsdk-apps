...
open class ComponentExecuteNodeExecutor : ExecuteNodeExecutor() {
    ...
    private fun executeAsy(svc: SvcLogicServiceBase, node: SvcLogicNode, svcLogicContext: SvcLogicContext): SvcLogicNode {
        ...
        try {
            ...
            stepInputs.putJsonElement(org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PROPERTY_CURRENT_NODE_TEMPLATE, nodeTemplateName)
            stepInputs.putJsonElement(org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PROPERTY_CURRENT_INTERFACE, interfaceName)
            stepInputs.putJsonElement(org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PROPERTY_CURRENT_OPERATION, operationName)
