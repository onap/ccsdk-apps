...
class BlueprintProcessorCatalogServiceImpl(bluePrintValidatorService: BluePrintValidatorService,
    ...
    override fun save(metadata: MutableMap<String, String>, archiveFile: File) {
        val artifactName = metadata[org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.METADATA_TEMPLATE_NAME]
        val artifactVersion = metadata[org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.METADATA_TEMPLATE_VERSION]
        ...
        blueprintModel.id = metadata[org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PROPERTY_BLUEPRINT_PROCESS_ID]
        blueprintModel.artifactType = ApplicationConstants.ASDC_ARTIFACT_TYPE_SDNC_MODEL
        blueprintModel.artifactName = artifactName
        blueprintModel.artifactVersion = artifactVersion
        blueprintModel.updatedBy = metadata[org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.METADATA_TEMPLATE_AUTHOR]
        blueprintModel.tags = metadata[org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.METADATA_TEMPLATE_TAGS]
        ...
        blueprintModelContent.id = metadata[org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PROPERTY_BLUEPRINT_PROCESS_ID]
