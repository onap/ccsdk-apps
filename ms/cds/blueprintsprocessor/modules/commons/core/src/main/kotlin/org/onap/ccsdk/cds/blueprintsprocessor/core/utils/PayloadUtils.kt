    ...
    companion object {
        ...
        fun prepareDynamicInputsFromComponentPayload(bluePrintRuntimeService: BluePrintRuntimeService<*>, payload: JsonNode) {
            payload.fields().forEach { property ->
                val path = StringBuilder(org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PATH_INPUTS)
                        .append(org.onap.ccsdk.cds.controllerblueprints.core.BluePrintConstants.PATH_DIVIDER).append(property.key).toString()
