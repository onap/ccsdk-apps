...
abstract class BlueprintCatalogServiceImpl(private val blueprintValidator: BluePrintValidatorService) : BluePrintCatalogService {
    ...
    override fun get(name: String, version: String, path: String): Boolean {
        val blueprintFile = File(path)

        getFromDatabase(name, version, blueprintFile)
    ...
    abstract fun getFromDatabase(name: String, version: String, blueprintFile: File)
}