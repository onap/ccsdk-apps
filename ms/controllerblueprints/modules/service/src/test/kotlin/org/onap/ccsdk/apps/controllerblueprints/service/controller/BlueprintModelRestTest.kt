...
@ComponentScan(basePackages = arrayOf("org.onap.ccsdk.apps.controllerblueprints"))
...
class BlueprintModelRestTest {
    ...
    private val blueprintModelSearch: BlueprintModelSearch? = null
    ...
    fun setUp() {
        blueprintFile = File(loadBluePrintPaths!!)
