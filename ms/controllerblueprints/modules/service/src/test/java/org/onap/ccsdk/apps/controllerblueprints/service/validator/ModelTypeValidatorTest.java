...
public class ModelTypeValidatorTest {
	...
	@Test
	public void testGetValidModelDefinitionType_definitionContentNULL() {
	...
	@Test
	public void testvalidateModelType_Null(){
		ModelType<BluePrintException> modelType = new ModelType<BluePrintException>(null);
		boolean valid=ModelTypeValidator.validateModelType(modelType);
		Assert.assertTrue(valid);
	}
	
	@Test(expected=BluePrintException.class)
	public void testvalidateModelType(){
		ModelType<BluePrintException> modelType = new ModelType<BluePrintException>();
