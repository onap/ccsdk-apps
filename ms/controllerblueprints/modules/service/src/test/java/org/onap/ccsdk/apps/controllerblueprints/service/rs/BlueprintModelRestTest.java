...
public class BlueprintModelRestTest {
    ...
    @Test
    public void test1_saveBluePrint() throws IOException {
    ...
    private void WebTestClient(HttpMethod requestMethod, BodyInserters.MultipartInserter body, String uri, HttpStatus expectedResponceStatus, Boolean setParam) {
        ...
        if (setParam) {
            Gson gson = new Gson();
            BlueprintModelSearch blueprintModelSearch = gson.fromJson(result, BlueprintModelSearch.class);
