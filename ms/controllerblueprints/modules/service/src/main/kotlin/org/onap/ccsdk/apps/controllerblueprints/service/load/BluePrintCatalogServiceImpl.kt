...
class BluePrintCatalogServiceImpl(private val bluePrintLoadConfiguration: BluePrintLoadConfiguration,
    ...
    private fun saveToDataBase(extractedDirectory: File, archiveFile: File, checkValidity: Boolean? = false) {
        ...
        configModel.id = id
        configModel.artifactType =  ApplicationConstants.ASDC_ARTIFACT_TYPE_SDNC_MODEL
        configModel.published = ApplicationConstants.ACTIVE_N
        ...
        configModelContent.id = id // For quick access both id's are same.always have one to one mapping.
