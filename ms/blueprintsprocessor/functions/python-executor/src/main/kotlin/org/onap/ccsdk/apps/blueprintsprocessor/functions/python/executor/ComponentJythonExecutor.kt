...
open class ComponentJythonExecutor(private val blueprintPythonService: BlueprintPythonService) : AbstractComponentFunction() {
    ...
    fun populateJythonComponentInstance(executionServiceInput: ExecutionServiceInput) {
        ...
        instanceDependenciesNode.forEach { instanceName ->
            dependencies.add(instanceName.textValue())
        }
