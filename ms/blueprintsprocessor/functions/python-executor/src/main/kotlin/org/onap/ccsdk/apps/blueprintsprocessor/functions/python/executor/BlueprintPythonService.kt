...
@Service
class BlueprintPythonService(var applicationContext: ApplicationContext, val pythonExecutorProperty: PythonExecutorProperty){

    inline fun <reified T> jythonInstance(blueprintContext: BluePrintContext, pythonClassName: String, content: String,
                                          dependencyInstanceNames: List<String>): T {
        ...
        jythonContextInstance["log"] = LoggerFactory.getLogger(pythonClassName)//TODO Change to nodeTempleName
        ...
        var pyObject = blueprintPythonHost.getPythonComponent(content, pythonClassName, jythonContextInstance)
