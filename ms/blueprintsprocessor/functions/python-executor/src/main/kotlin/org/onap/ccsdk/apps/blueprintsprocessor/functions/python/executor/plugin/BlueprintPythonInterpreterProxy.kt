...
open class BlueprintPythonInterpreterProxy(private var bluePrintPython: BluePrintPython): PythonInterpreter(){
    ...
    fun getPythonInstance(properties: MutableMap<String, Any>): PyObject{
        ...
        val initCommand = bluePrintPython.targetClassName.plus(" = ").plus(
                                                        bluePrintPython.targetClassName).plus("()")
        this.exec(initCommand)

        return this.get(bluePrintPython.targetClassName)
    }
}