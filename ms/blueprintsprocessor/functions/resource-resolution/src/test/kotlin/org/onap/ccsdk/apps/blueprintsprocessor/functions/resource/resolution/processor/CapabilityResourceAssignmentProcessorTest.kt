...
class CapabilityResourceAssignmentProcessorTest {
    ...
    fun `test jython capability`() {
        ...
        val content = JacksonUtils.getContent("./../../../../components/model-catalog/blueprint-model/starter-blueprint/baseconfiguration/Scripts/SampleResourceAssignmentProcessorScript.py")

        capabilityResourceAssignmentProcessor.raRuntimeService = resourceAssignmentRuntimeService
        capabilityResourceAssignmentProcessor.resourceDictionaries = hashMapOf()

        val resourceAssignmentProcessor = capabilityResourceAssignmentProcessor
                .getJythonResourceAssignmentProcessorInstance(
                        "SampleJythonComponentNode", content, scriptPropertyInstances)

        assertNotNull(resourceAssignmentProcessor, "couldn't get Jython script resource assignment processor")
