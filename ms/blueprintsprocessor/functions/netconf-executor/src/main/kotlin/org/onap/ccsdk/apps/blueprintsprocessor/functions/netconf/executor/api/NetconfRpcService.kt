...
interface NetconfRpcService {
     ...
     */
    fun lock(configTarget: NetconfDatastore = NetconfDatastore.CANDIDATE): DeviceResponse
     ...
     * @return Device response
     */
    fun deleteConfig(configTarget: NetconfDatastore = NetconfDatastore.CANDIDATE): DeviceResponse
     ...
     * @return Device response
     */
    fun editConfig(messageContent: String, configTarget: NetconfDatastore,
                   editDefaultOperation: ModifyAction = ModifyAction.NONE): DeviceResponse
     ...
     * @return Device response
     */
    fun validate(configTarget: NetconfDatastore = NetconfDatastore.CANDIDATE): DeviceResponse
     ...
     * @return Device response
     */
    fun unLock(configTarget: NetconfDatastore = NetconfDatastore.CANDIDATE): DeviceResponse
