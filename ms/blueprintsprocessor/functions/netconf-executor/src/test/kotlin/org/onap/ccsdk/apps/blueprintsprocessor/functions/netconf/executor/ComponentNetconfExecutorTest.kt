...
class ComponentNetconfExecutorTest {
    ...
    fun testComponentNetconfExecutor() {
        ...
        //get the requirements capabilities.
        //val = bluePrintRuntimeService.resolveNodeTemplateRequirementProperties()
        ...
        bluePrintRuntimeService.put("capabilityProperty ",capabilityProperty.asJsonNode())
        ...
        stepMetaData.putJsonElement("deviceInfo", deviceInfo)
