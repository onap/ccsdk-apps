...
import org.onap.ccsdk.apps.controllerblueprints.core.repository.ModelContentRepository
import org.onap.ccsdk.apps.controllerblueprints.core.repository.ModelRepository
 ...
 */
@MappedSuperclass
abstract class BlueprintCatalogServiceImpl<T, B>(private val bluePrintLoadConfiguration: BluePrintLoadConfiguration,
                                                 val bluePrintValidatorService: BluePrintValidatorService,
                                                 val blueprintModelContentRepository: ModelContentRepository<T, B>,
                                                 val blueprintModelRepository: ModelRepository<T>) : BluePrintCatalogService {
